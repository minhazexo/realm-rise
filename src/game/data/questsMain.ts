...
export interface QuestRewards {
  ...
  recruitRoll?: boolean;
  flagsSet?: string[];
  happinessTown?: number;
}

export interface QuestChoice {
  label: string;
  // Consequence payload keys vary per choice (gold, rep, escort flag, ...).
...
export const QUEST_ORDER: string[] = Object.keys(MAIN_QUESTS);
