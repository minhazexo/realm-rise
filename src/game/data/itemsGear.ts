...
def('dawnbreaker', { name: 'Dawnbreaker', cat: 'weapon', weapon: { dmg: 36, crit: 0.18, cd: 0.4, range: 56, style: 'slash', element: 'fire', special: 'dawnbreaker', heavy: true }, rarity: 'mythic', durability: 999, value: 1000, icon: { shape: 'sword', c1: '#ffd66b' }, desc: 'Legendary blade reforged from an Ancient Core. Charged attacks release a burning wave.' });
