...
/** Particle-emitter config fields scaled by the quality throttle. */
export interface ThrottleableParticleConfig {
  quantity?: number;
  frequency?: number;
  [key: string]: unknown;
}
 ...
 */
export function throttleConfig(cfg: ThrottleableParticleConfig = {}): ThrottleableParticleConfig | null {
 ...
 */
export function particleConfig(cfg: ThrottleableParticleConfig): ThrottleableParticleConfig | null { return throttleConfig(cfg); }
