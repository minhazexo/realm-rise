...
// ─────────────────────────────────────────────────────────────────────────────
import { single, rr, circ, ell, tri, O } from './artCore.ts';
 ...
 * @param stage  1 | 2 | 3
 */
function farmDraw(ctx: CanvasRenderingContext2D, w: number, h: number, stage: number): void {
  // ground shadow
 ...
 */
export function buildStructureProps2(scene: Phaser.Scene): void {
