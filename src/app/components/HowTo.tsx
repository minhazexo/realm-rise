...
export default function HowTo({ onBack }: HowToProps): JSX.Element {
  return (
    <div className="panel howto-panel">
      <h2>How to Survive & Rise</h2>
      <div className="howto-grid">
        <div><b>Keyboard</b><p>WASD/Arrows move · Mouse click attack · E gather · Shift sprint · Space dodge · Right-click block · Wheel/+/-/Z/X camera zoom</p></div>
...
export function Credits({ onBack }: CreditsInfoProps): JSX.Element {
  return (
